...
export const FILTER_GROUPS: FilterGroupMeta[] = [
  ...
  { key: "age", label: "ក្រុមអាយុ", description: "ក្រុមអាយុគោលដៅ" },
  {
    ...
    description: "ប្រភេទម្ហូបតាមប្រទេសដើម",
  },
  {
    key: "allergen",
  ...
  { key: "spice", label: "កម្រិតហឹរ", description: "កម្រិតហឹរនៃម្ហូប" },
  {
    key: "prepTime",
    label: "ពេលរៀបចំ",
    description: "រយៈពេលរៀបចំ/ដឹកជញ្ជូនកម្រិត",
  },
  {
    key: "season",
    label: "រដូវកាលនៅកម្ពុជា",
    description: "ម្ហូបតាមរដូវកាលនៅកម្ពុជា",
  },
  {
    key: "festival",
    label: "ពិធីបុណ្យ និងព្រឹត្តិការណ៍",
    description: "ម្ហូបពិសេសសម្រាប់ពិធីបុណ្យ",
  },
  {
    key: "popularProvince",
    label: "ពេញនិយមតាមខេត្ត",
    description: "ម្ហូបពេញនិយមតាមខេត្តនីមួយៗ",
  },
  {
    key: "weather",
    label: "សមស្របតាមអាកាសធាតុ",
    description: "ម្ហូបសមស្របតាមអាកាសធាតុ",
  },
  {
    key: "originProvince",
    label: "ប្រភពដើមតាមខេត្ត",
