...
/* =========================================================
   ...
   storeUuid is optional on purpose.

   If page.tsx fails to pass it correctly,
   this component can recover it from useParams().
========================================================= */
...
export default function ShopDetailManager({
  ...
  /* =======================================================
     ...
     This happens before any backend request.
  ======================================================= */
