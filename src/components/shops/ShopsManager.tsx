...
export default function ShopsManager() {
  ...
  const filtered =
    filter === "ALL" ? stores : stores.filter((s) => s.reviewStatus === filter);
      ...
      <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
        ...
        <div className="flex flex-col gap-2 sm:flex-row">
          <div className="flex sm:w-[360px]">
            <label className="relative flex-1">
              ...
              <input
                ...
                className="h-11 w-full rounded-l-2xl border border-r-0 pl-11 pr-3 text-sm"
              />
            </label>
            <button
              onClick={() => {
              ...
              className="rounded-r-2xl bg-[#137A3D] px-4 text-sm font-black text-white"
            >
              Search
            </button>
          </div>
          <select
            ...
            className="h-11 rounded-2xl border bg-white px-4 text-sm font-black"
          >
            {[10, 20, 50].map((x) => (
      ...
      <section className="overflow-hidden rounded-[26px] border border-gray-100 bg-white shadow-sm">
        {isLoading ? (
          ...
          <div className="flex min-h-[340px] flex-col items-center justify-center">
            <Store size={42} className="text-gray-300" />
            <p className="mt-3 font-black text-gray-600">មិនមាន Store</p>
          </div>
        ) : (
          <ShopsTable
            stores={filtered}
