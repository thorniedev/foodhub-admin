        ...
        <div className="flex flex-wrap items-center gap-3">
          <div className="relative w-full lg:w-[420px]">
            ...
            <input
              ...
              className="h-[52px] w-full rounded-full border border-gray-200 bg-white py-2 pl-12 pr-10 text-lg text-gray-700 outline-none transition focus:border-primary-600 focus:ring-4 focus:ring-primary-100"
            />
            ...
            {searchInput && (
              <button
                ...
                className="absolute right-3 top-1/2 z-10 -translate-y-1/2 rounded-full p-1 text-gray-400 transition hover:bg-gray-100 hover:text-gray-700"
            ...
            {showSuggestions && searchInput.trim().length >= 2 && (
              <div className="absolute left-0 top-[60px] z-[100] w-full overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-[0_18px_50px_rgba(0,0,0,0.13)]">
                {suggestionsLoading ? (
          ...
          <div className="relative">
            <button
              ...
              className={`flex h-[52px] min-w-[130px] items-center justify-between gap-3 rounded-full border bg-white px-5 text-lg font-medium transition ${sizeOpen
                ? "border-[#137A3D] ring-4 ring-emerald-50"
            ...
            {sizeOpen && (
              <div className="absolute right-0 top-[60px] z-[100] w-[170px] rounded-2xl border border-gray-100 bg-white p-2 shadow-[0_15px_45px_rgba(0,0,0,0.12)]">
          ...
          <div className="relative">
            <button
              ...
              className={`flex h-[52px] w-[52px] items-center justify-center rounded-full border transition ${sortOpen
                ...
                : "border-gray-200 bg-white text-gray-600 hover:border-gray-300 hover:text-[#137A3D]"
                }`}
