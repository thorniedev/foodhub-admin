...
import type { CreateAdminProfilePayload } from "@/src/types/userProfile";
          ...
          <div className="space-y-4 p-6 sm:p-8">
            ...
            <div className="flex flex-col items-center justify-center gap-3 rounded-2xl border border-dashed border-gray-200 bg-gray-50/60 p-5 text-center">
              ...
              <div>
                ...
                >
                  {uploadingAvatar ? "កំពុង Upload រូបភាព..." : avatarPreview ? "ប្តូររូបភាព Profile" : "+ ជ្រើសរើសរូបភាព Profile"}
                </button>
            ...
            <div className="flex items-center justify-between rounded-2xl border border-gray-100 bg-gray-50/70 p-4">
              ...
              <input
                ...
                {...register("isDefault")}
                disabled={isBusy}
                className="h-5 w-5 rounded-lg border-gray-300 text-primary-800 focus:ring-primary-600"
              />
            </div>
          </div>
