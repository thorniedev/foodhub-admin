...
export default function ProfileActionConfirmModal({
  ...
  return (
    <div className="fixed inset-0 z-[130] flex items-center justify-center bg-black/45 p-4 backdrop-blur-[3px]">
      <div className="relative w-full max-w-lg overflow-hidden rounded-[30px] border border-gray-100 bg-white shadow-2xl animate-in fade-in zoom-in-95 duration-200">
        {/* Close Button */}
        <button
          type="button"
          disabled={loading}
        ...
        <div
          className={`flex flex-col items-center justify-center px-8 pt-9 pb-4 text-center ${
            isSuspend
        ...
        >
          <div
            className={`flex h-18 w-18 items-center justify-center rounded-2xl shadow-md ring-4 ${
              isSuspend
        ...
        <div className="p-8 pt-2 space-y-5 text-center">
          ...
          <div className="grid grid-cols-2 gap-4 pt-2">
            ...
            <button
              ...
              className={`inline-flex h-14 items-center justify-center gap-2 rounded-2xl px-6 text-lg font-bold shadow-md transition-all hover:scale-[1.02] active:scale-95 disabled:opacity-60 ${
                isSuspend
                  ? "bg-amber-400 text-amber-950 shadow-amber-950/10 hover:bg-amber-300 font-black"
