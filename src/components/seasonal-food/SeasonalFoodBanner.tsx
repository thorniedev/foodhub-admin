...
export default function SeasonalFoodBanner({
  ...
  return (
    <div className="bg-gradient-to-r bg-[#136C34] rounded-2xl p-6 mb-6 text-white">
      <div className="flex items-start justify-between flex-wrap gap-4">
        <div className="flex items-start gap-3">
          ...
          <div>
            <p className="text-5xl font-bold">រូបភាពអាហារតាមរដូវកាល</p>
            <p className="text-emerald-50 text-lg mt-3 max-w-md">
      ...
      <div className="flex items-center gap-4 mt-6 flex-wrap">
        <div className="bg-white/10 rounded-xl px-4 py-3 min-w-[140px]">
          <p className="text-lg text-emerald-50">សរុបទាំងអស់</p>
          <p className="text-xl font-bold">{total}</p>
        </div>
        <div className="bg-white/10 rounded-xl px-4 py-3 min-w-[140px]">
          <p className="text-lg text-emerald-50">កំពុងបង្ហាញ</p>
          <p className="text-xl font-bold">{activeCount}</p>
        </div>
        <div className="bg-white/10 rounded-xl px-4 py-3 min-w-[140px]">
          <p className="text-lg text-emerald-50">កំពុងរង់ចាំ</p>
