    ...
    <div className="bg-gradient-to-r bg-[#136C34] rounded-2xl p-6 mb-6 text-white">
      <div className="flex items-start justify-between flex-wrap gap-4">
        <div className="flex items-start gap-3">
          ...
          <div>
            <p className="text-5xl font-bold">ការត្រង</p>
            <p className="text-emerald-50 text-base mt-3 max-w-md">
      ...
      <div className="flex items-center gap-4 mt-6 flex-wrap">
        <div className="bg-white/10 rounded-xl px-4 py-3 min-w-[140px]">
          <p className="text-base text-emerald-50">ក្រុមជម្រើសទាំងអស់</p>
          <p className="text-xl font-bold">{totalGroups}</p>
        </div>
        <div className="bg-white/10 rounded-xl px-4 py-3 min-w-[140px]">
          <p className="text-base text-emerald-50">ជម្រើសសរុប</p>
          <p className="text-xl font-bold">{totalOptions}</p>
        </div>
        <div className="bg-white/10 rounded-xl px-4 py-3 min-w-[140px]">
          <p className="text-base text-emerald-50">កំពុងបង្ហាញ</p>
