...
export default function Sidebar() {
  ...
  // Renders a single nav item — with an expandable section if it has children,
  // otherwise a flat link. Used by BOTH the main nav and the footer nav.
  ...
  return (
    <aside className="w-64 h-screen bg-white border-r border-gray-100 flex flex-col justify-between">
      <div>
        ...
        <nav className="px-3 mt-6 space-y-1">
          {dashboardFooterNav.map(renderItem)}
        </nav>
      </div>
