  ...
  return (
    <header className="sticky top-0 z-40 flex min-h-[84px] flex-wrap items-center justify-between gap-4 border-b border-gray-100 bg-white px-4 py-4 md:flex-nowrap md:px-8">
      ...
      <div className="flex min-w-0 items-center gap-3">
        ...
        {/* Page title */}
        <div className="flex min-w-0 items-center gap-2 text-base font-semibold text-gray-800 md:text-lg">
          {parent && (
            <>
      ...
      <div className="flex w-full flex-wrap items-center justify-between gap-3 md:w-auto md:flex-nowrap md:justify-end md:gap-5">
        ...
        >
          <button
            type="submit"
            title="Log out"
            className="inline-flex items-center gap-2 rounded-xl px-2.5 py-2 text-sm text-gray-500 transition hover:bg-red-50 hover:text-red-600"
          >
            <LogOut size={18} />
