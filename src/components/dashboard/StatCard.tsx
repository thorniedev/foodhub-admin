import { Users, TrendingUp, ShoppingBag, Layers, LucideIcon } from "lucide-react";
...
export default function StatCard({ data }: { data: StatCardData }) {
  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-100 p-5 flex items-start gap-4">
      <div className={`w-11 h-11 rounded-xl ${data.iconBg} flex items-center justify-center text-white shrink-0`}>
        <Icon size={20} />
      </div>
      <div>
