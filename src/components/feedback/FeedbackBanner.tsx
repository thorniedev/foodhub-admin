      ...
      <div className="relative flex flex-col gap-7 lg:flex-row lg:items-start lg:justify-between">
        ...
        <div className="min-w-0">
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="min-w-0">
              ...
              <p className="mt-6 max-w-3xl text-xl leading-8 text-white/85">
                តាមដាន និងឆ្លើយតបទៅនឹងមតិកែលម្អពីអតិថិជន  <br className="md:block max-md:hidden" />ទាក់ទងនឹងកម្មវិធី
                គុណភាពអាហារ ការដឹកជញ្ជូន និងសេវាកម្ម។
              </p>
            </div>
          </div>
          ...
          <div className="mt-7 grid grid-cols-1 gap-3 sm:grid-cols-2 xl:grid-cols-4">
            ...
            <RatingStatCard averageRating={averageRating} />
          </div>
        </div>
...
function RatingStatCard({ averageRating }: { averageRating: number }) {
  return (
    <div className="rounded-3xl bg-white/20 px-5 py-4">
      <div className="flex items-center gap-2 text-xl text-white/80">
        <Star size={20} className="fill-secondary-400 text-secondary-400" />
