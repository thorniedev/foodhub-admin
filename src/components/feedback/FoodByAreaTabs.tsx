      ...
      <div className="flex items-center gap-2 flex-wrap">
        {AREA_TAB_LABELS.map((tab) => (
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2 rounded-full text-base font-medium transition-colors ${activeTab === tab.key
          ...
          >
            {tab.label}
            <span
              className={`text-base rounded-full px-1.5 py-0.5 ${activeTab === tab.key
