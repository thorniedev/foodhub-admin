...
interface HardDeleteMedicalConditionConfirmModalProps {
...
export default function HardDeleteMedicalConditionConfirmModal({
  item,
  deleting,
  onClose,
  onConfirm,
}: HardDeleteMedicalConditionConfirmModalProps) {
  useEffect(() => {
    if (!item) return;
