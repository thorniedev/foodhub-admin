      ...
      <div className="relative my-8 w-full max-w-2xl rounded-[32px] border border-gray-100 bg-white p-6 shadow-2xl sm:p-8">
        ...
        {isLoading && !data ? (
          ...
          <div className="mt-6 space-y-5">
            ...
            <div className="space-y-2 rounded-2xl border border-gray-100 bg-amber-50/30 p-4">
              <div className="flex items-center justify-between">
              ...
              {displayItem.updatedAt && (
                <div className="mt-3 flex items-center gap-1.5 pt-2 border-t border-amber-100/60 text-xs text-gray-500">
