  ...
  return (
    <div className="flex flex-col gap-3 border-t border-gray-100 px-5 py-4 sm:flex-row sm:items-center sm:justify-between">
      <p className="text-lg text-gray-500">
        សរុប <span className="font-normal text-gray-700">{totalElements}</span> គ្រឿងផ្សំ
      </p>
      ...
      <div className="flex items-center gap-2">
        ...
        <span className="flex h-10 min-w-10 items-center justify-center rounded-lg bg-[#136C34] px-3.5 text-lg font-normal text-white">
