...
export default function DietaryTypeDetailModal({
  ...
  const swaggerApiPath = `/api/v1/admin/dietary-types/${identifier}`;
    ...
    const fetchDetail = async () => {
      try {
        ...
        const json = (await res.json()) as
          | ApiResponseEnvelope<DietaryType>
          | DietaryType;
        ...
        if (json && typeof json === "object") {
          if ("payload" in json && json.payload && typeof json.payload === "object") {
            detail = json.payload as DietaryType;
          } else if ("data" in json && json.data && typeof json.data === "object") {
            detail = json.data as DietaryType;
          } else {
            detail = json as DietaryType;
          }
        }
        ...
        if (!isMounted) return;
        console.warn(`[DietaryTypeDetailModal] Could not fetch ${endpointPath}:`, err);
        setIsError(true);
          ...
          <div className="mt-6 space-y-5">
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              ...
              <div className="rounded-2xl border border-gray-100 bg-gray-50/70 p-4 transition hover:bg-gray-50">
                ...
                <p className="mt-2">
                  <span className="inline-flex rounded-full bg-secondary-50 px-4 py-1 text-lg font-normal text-secondary-700 ring-1 ring-inset ring-secondary-100">
