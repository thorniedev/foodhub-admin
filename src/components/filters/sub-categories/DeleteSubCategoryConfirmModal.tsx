      ...
      <div className="relative w-full max-w-md rounded-3xl bg-white p-6 shadow-2xl transition-all">
        <div className="flex flex-col items-center text-center">
          ...
          <div className="mt-3 w-full rounded-2xl bg-gray-50 p-4">
            ...
            <p className="mt-1 font-mono text-lg text-gray-400">{item.code}</p>
          </div>
          ...
          <div className="mt-6 flex w-full items-center justify-center gap-3">
            <button
              ...
              disabled={deleting}
              onClick={onClose}
              className="flex-1 min-h-12 rounded-full border border-gray-200 py-2.5 text-lg font-bold text-gray-700 transition hover:bg-gray-50 focus:outline-none"
            >
              បោះបង់
            </button>
            ...
            <button
              ...
              disabled={deleting}
              onClick={onConfirm}
              className="flex-1 min-h-12 inline-flex items-center justify-center gap-2 rounded-full bg-red-600 py-2.5 text-lg font-bold text-white shadow-sm transition hover:bg-red-700 focus:outline-none focus:ring-4 focus:ring-red-500/20 disabled:opacity-60"
            >
