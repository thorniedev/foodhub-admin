...
export default function WeatherConditionTable({
  ...
  onRestore: (item: WeatherCondition) => void;
}) {
  if (items.length === 0) {
    return (
      <div className="flex min-h-[320px] flex-col items-center justify-center px-5 text-center">
        ...
        <p className="mt-2 max-w-md text-lg leading-7 text-gray-500">
          បន្ថែមស្ថានភាពអាកាសធាតុដូចជា Rainy, Sunny ឬ Hot។
        </p>
      </div>
    );
  }
                  ...
                  <div className="flex justify-end gap-2">
                    ...
                    {active ? (
                      ...
                      <button
                        ...
                        className="flex h-10 w-10 items-center justify-center rounded-full border border-emerald-200 bg-emerald-50 text-emerald-700 transition hover:bg-emerald-100 disabled:opacity-40"
