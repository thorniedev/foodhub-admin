...
export const INITIAL_FILTER_OPTIONS: FilterCatalogOption[] = [
  ...
  seed("REGION", "KANDAL", "Kandal", "កណ្តាល"),
  seed("REGION", "SIEM_REAP", "Siem Reap", "សៀមរាប"),
  seed("REGION", "BATTAMBANG", "Battambang", "បាត់ដំបង"),
  seed("REGION", "BANTEAY_MEANCHEY", "Banteay Meanchey", "បន្ទាយមានជ័យ"),
  seed("REGION", "KAMPONG_CHAM", "Kampong Cham", "កំពង់ចាម"),
  seed("REGION", "KAMPONG_CHHNANG", "Kampong Chhnang", "កំពង់ឆ្នាំង"),
  seed("REGION", "KAMPONG_SPEU", "Kampong Speu", "កំពង់ស្ពឺ"),
  seed("REGION", "KAMPONG_THOM", "Kampong Thom", "កំពង់ធំ"),
  seed("REGION", "KAMPOT", "Kampot", "កំពត"),
  seed("REGION", "KEP", "Kep", "កែប"),
  seed("REGION", "KOH_KONG", "Koh Kong", "កោះកុង"),
  seed("REGION", "KRATIE", "Kratie", "ក្រចេះ"),
  seed("REGION", "MONDULKIRI", "Mondulkiri", "មណ្ឌលគិរី"),
  seed("REGION", "ODDAR_MEANCHEY", "Oddar Meanchey", "ឧត្តរមានជ័យ"),
  seed("REGION", "PAILIN", "Pailin", "ប៉ៃលិន"),
  seed("REGION", "PREAH_SIHANOUK", "Preah Sihanouk", "ព្រះសីហនុ"),
  seed("REGION", "PREAH_VIHEAR", "Preah Vihear", "ព្រះវិហារ"),
  seed("REGION", "PREY_VENG", "Prey Veng", "ព្រៃវែង"),
  seed("REGION", "PURSAT", "Pursat", "ពោធិ៍សាត់"),
  seed("REGION", "RATANAKIRI", "Ratanakiri", "រតនគិរី"),
  seed("REGION", "STUNG_TRENG", "Stung Treng", "ស្ទឹងត្រែង"),
  seed("REGION", "SVAY_RIENG", "Svay Rieng", "ស្វាយរៀង"),
  seed("REGION", "TAKEO", "Takeo", "តាកែវ"),
  seed("REGION", "TBOUNG_KHMUM", "Tboung Khmum", "ត្បូងឃ្មុំ"),
