...
export const FILTER_GROUPS: FilterGroupDefinition[] = [
  ...
  },
  {
    ...
    descriptionKm: "Calories, Protein, Fat, Fiber, Sodium និងជម្រើសអាហារូបត្ថម្ភ។",
    selectionMode: "MULTIPLE",
    source: "LOCAL",
  },
  {
...
export const INITIAL_FILTER_OPTIONS: FilterCatalogOption[] = [
  ...
  seed("PREPARATION_TIME", "PREP_10", "10 minutes", "ក្រោម 10 នាទី", 10, "MINUTE"),
  seed("PREPARATION_TIME", "PREP_15", "15 minutes", "ក្រោម 15 នាទី", 15, "MINUTE"),
  seed("PREPARATION_TIME", "PREP_20", "20 minutes", "ក្រោម 20 នាទី", 20, "MINUTE"),
  ...
  seed("NUTRITION", "CALORIES_400", "Calories under 400", "កាឡូរីក្រោម 400", 400, "KCAL"),
  seed("NUTRITION", "PROTEIN_25G", "Protein 25g or more", "ប្រូតេអ៊ីន 25g ឡើង", 25, "G"),
  seed("NUTRITION", "FAT_10G", "Fat under 10g", "ជាតិខ្លាញ់ក្រោម 10g", 10, "G"),
  seed("NUTRITION", "FIBER_5G", "Fiber 5g or more", "Fiber 5g ឡើង", 5, "G"),
  seed("NUTRITION", "SODIUM_600MG", "Sodium under 600mg", "Sodium ក្រោម 600mg", 600, "MG"),
